from BitVector import * #use BitVector class
import math #import math module to use function such as ceiling

#findroundkey takes in the hex pass string of the size 32 and an integer value between 1-10 for the round number.
#After operations are performed, a hex pass string of the size 32 is generated.
